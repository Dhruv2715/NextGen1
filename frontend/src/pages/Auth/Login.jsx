    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 1 }}>
        ...
        <form onSubmit={handleLogin}>
          ...
          <div className="mb-4">
            ...
            <div className="flex bg-gray-100 p-1 rounded-lg">
              <button
                type="button"
                className={`flex-1 py-1.5 text-sm font-medium rounded-md transition-all ${role === 'candidate' ? 'bg-white shadow text-black' : 'text-gray-500 hover:text-gray-700'}`}
              ...
              <button
                type="button"
                className={`flex-1 py-1.5 text-sm font-medium rounded-md transition-all ${role === 'interviewer' ? 'bg-white shadow text-black' : 'text-gray-500 hover:text-gray-700'}`}
        ...
        <div className="mt-3 flex items-center justify-center gap-3 w-full">
          ...
          >
            Wanna just explore NextGen. Use Demo Credentials
          </span>
