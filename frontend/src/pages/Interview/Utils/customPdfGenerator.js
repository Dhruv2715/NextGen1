  ...
  try {
    ...
    container.innerHTML = `
      ...
      <div class="header" style="text-align: center; margin-bottom: 40px; border-bottom: 2px solid black; padding-bottom: 20px;">
        <div class="brand-main" style="font-size: 32px; font-weight: 700; margin-bottom: 8px; letter-spacing: 1px;">NextGen AI</div>
        <div class="subtitle" style="font-size: 18px; font-weight: 600; margin-bottom: 20px; color: #333;">Detailed Report - Interview</div>
        <div class="brand-footer" style="font-size: 12px; font-weight: 700; letter-spacing: 2px; color: #666;">NEXTGEN</div>
      </div>
      ...
      <div class="footer" style="margin-top: 40px; text-align: center; font-size: 10px; color: #999; border-top: 1px solid #eee; padding-top: 20px;">
        Generated by NextGen AI - Professional Interview Analysis Platform<br>
    ...
    const fileName = `NextGen_Interview_Report_${timestamp}.pdf`;
